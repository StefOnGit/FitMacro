...
void reco(string run, string adcn){
  ...
  cin.getline(dname,sizeof(dname));
  cout<<"\nSetting -->"<<dname<<endl;
  data->SetTitle(dname);
  ...
  float rf_min1 = 45, rf_max1 = 170;             //fit range
  
  //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  
  int n_par2 = 3;                                   //n parameter
  float rf_min2 = 47, rf_max2 = 71;             //fit range
  
  //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  
  int n_par3 = 3;                                   //n parameter
  float rf_min3 = 25, rf_max3 = 35;             //fit range
  ...
  TF1 *Gauss10 = new TF1("Gauss10",Gauss,0,200,3);
  Gauss10->SetLineColor(kBlue);
  Gauss10->SetNpx(500);
  TF1 *Gauss11 = new TF1("Gauss11",Gauss,0,200,3);
  Gauss11->SetLineColor(kBlue+1);
  Gauss11->SetNpx(500);
  TF1 *Gauss12 = new TF1("Gauss12",Gauss,0,200,3);
  ...
  legend->AddEntry((TObject*)0,Form("sigma_1 = %.2f",par1[1]), "");
  legend->AddEntry((TObject*)0,Form("sigma_2 = %.2f",par1[4]), "");
  legend->AddEntry((TObject*)0,Form("sigma_3 = %.2f",par1[7]), "");
  legend->Draw();
  ...
  TF1 *Gauss20 = new TF1("Gauss20",Gauss,0,200,3);
  ...
  legend1->AddEntry((TObject*)0,Form("mean = %.2f",par2[0]), "");
  legend1->AddEntry((TObject*)0,Form("sigma = %.2f",par2[1]), "");
  legend1->Draw();
  ...
  pad3->cd();
  data->Draw();
  TF1 *Gauss30 = new TF1("Gauss30",Gauss,0,200,3);
  ...
  legend2->AddEntry((TObject*)0,Form("mean = %.2f",par3[0]), "");
  legend2->AddEntry((TObject*)0,Form("sigma = %.2f",par3[1]), "");
  legend2->Draw();
  
  //-------------------------------------------------------------------------------
  float dist = (par2[0]-par3[0])/par2[1];
  cout<<"\nDISTANZA in sigma1 = "<<dist<<endl;
